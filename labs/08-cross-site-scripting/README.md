...
| [`01-dvwa-reflected-xss-summary.png`](screenshots/08-cross-site-scripting/01-dvwa-reflected-xss-summary.png) | Screenshot of the reflected XSS observation summary. |
