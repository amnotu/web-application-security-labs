...
|---|---|
| [`dvwa-reflected-xss-summary.txt`](labs/08-cross-site-scripting/evidence/dvwa-reflected-xss-summary.txt) | Public-safe reflected XSS behavior summary. |
| `01-dvwa-reflected-xss-summary.png` | Screenshot of the reflected XSS observation summary. |
