# Lab 02: HTTP, Methodology, and Traffic Capture
...
|---|---|
| `http-juiceshop-curl-observation.txt` | HTTP headers and verbose curl request/response flow. |
| `packet-capture-summary.txt` | Safe summary of captured TCP traffic to Juice Shop. |
| `01-http-juiceshop-curl-observation.png` | Screenshot of HTTP curl observation evidence. |
| `02-packet-capture-summary.png` | Screenshot of packet capture summary evidence. |

Screenshot locations:

`assets/screenshots/02-http-methodology-and-traffic-capture/01-http-juiceshop-curl-observation.png`

`assets/screenshots/02-http-methodology-and-traffic-capture/02-packet-capture-summary.png`

Text evidence locations:

`labs/02-http-methodology-and-traffic-capture/evidence/http-juiceshop-curl-observation.txt`

`labs/02-http-methodology-and-traffic-capture/evidence/packet-capture-summary.txt`

Local-only evidence:

`labs/02-http-methodology-and-traffic-capture/evidence/juiceshop-basic-http.pcap`
